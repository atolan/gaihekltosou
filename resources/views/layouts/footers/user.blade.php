<footer id="footer" class="fixed-bottom">
  <ul class="nav nav-fill bg-topbar">
    <li class="nav-item">
      <a class="footer-nav-link text-white" href="{{ route('user.painter') }}">
        <div class="link-area">
    ...
    <li class="nav-item">
      <a class="footer-nav-link text-white" href="{{ route('user.example') }}">
        <div class="link-area">
    ...
    <li class="nav-item">
      <a class="footer-nav-link text-white" href="{{ route('user.painter.favorite') }}">
        <div class="link-area">
    ...
    <li class="nav-item">
      <a class="footer-nav-link text-white" href="/api/workflow/user">
        <div class="link-area">
    ...
    <li class="nav-item">
    <a class="footer-nav-link text-white" href="{{ route('user.mypage') }}">
        <div class="link-area">
