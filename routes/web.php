...
Route::prefix('user')->group(function(){
    ...
    Route::get('chat/{painter_id}/{request_id}', 'User\UserController@chat')->name('user.chat');
...
Route::prefix('painter')->group(function(){
    ...
    Route::get('chat/{request_id}', 'Painter\PainterController@chat')->name('painter.chat');
